...
---@class menori.Scene : menori.Class
---@field dt number
...
---@param node menori.Node
---@param environment menori.Environment
---@param renderstates any
---@param filter? fun(node, scene, environment)
---@return integer
function scene:render_nodes(node, environment, renderstates, filter)
      ...
      if renderstates.clear then
            if renderstates.colors then
                  lovg.clear(table.unpack(renderstates.colors))
            else
                  lovg.clear()
            end
      end

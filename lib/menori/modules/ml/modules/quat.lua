...
local vec3 = require("ml.modules.vec3")
local mat4 = require("ml.modules.mat4")
...
---@param axis? menori.vec3
function quat.from_angle_axis_checked(angle, axis)
	axis = axis or vec3(0, 1, 0)
	local deg = math.deg(angle)
	if deg > 360 then
		deg = deg - 360
	end
	return quat.from_angle_axis(math.rad(deg), axis)
end

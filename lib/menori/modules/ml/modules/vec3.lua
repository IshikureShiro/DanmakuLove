...
local utils = require("ml.modules.utils")

---@class menori.vec3
---@field __call fun(x?, y?, z?):menori.vec3
---@field set fun(self: self, x: number, y: number, z: number):menori.vec3
---@field x number
---@field y number
---@field z number
local vec3 = {}
...
function vec3_mt:lerp(b, t)
	return vec3.lerp(self, b, t)
end
...
vec3 = setmetatable(vec3, vec3_mt)

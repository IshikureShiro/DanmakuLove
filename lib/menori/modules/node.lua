...
---@class menori.Node : menori.Class
---@field render fun(self: self, scene: menori.Scene, env: menori.Environment)?
---@field update fun(self: self, scene: menori.Scene, env: menori.Environment)?
---@field position menori.vec3
---@field rotation menori.quat
